...
class EditBusiness2 extends StatefulWidget {
  final Business busdata;
  EditBusiness2(this.busdata);

  @override
  _EditBusiness2State createState() => _EditBusiness2State();
}

class _EditBusiness2State extends State<EditBusiness2> {
