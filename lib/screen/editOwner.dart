...
class _editOwnerState extends State<editOwner> {
 ...
 changetext(){
   ...
   String split1 = this.widget.ownerdata.birth_date;
     owner_code.text = this.widget.ownerdata.owner_code.toString();
    last_name.text = this.widget.ownerdata.last_name;
    first_name.text = this.widget.ownerdata.first_name;
    middle_name.text = this.widget.ownerdata.middle_name;
    extension.text = this.widget.ownerdata.extension;

    gender.text = this.widget.ownerdata.gender;
    nationality.text = this.widget.ownerdata.nationality;
    contact_no.text = this.widget.ownerdata.contact_no;
    photo.text = this.widget.ownerdata.photo;
    address.text = this.widget.ownerdata.address;
    email.text = this.widget.ownerdata.email;
    update_by.text = this.widget.ownerdata.update_by;
  ...
  // _editOwner(context, int getId, Owner owndata) async {
  //   try {
  //     var _ownerServices = OwnerServices();
  //     var registeredUser = await _ownerServices.editOwner(getId,owndata);
  //     var _list = json.decode(registeredUser.body);
  //     print(_list);
  //     if (_list['url'] != null) {
  //      _showCorrect(context, "Data update save");
  //     } else {
  //       _showError(context, "Check Internet Connection");
  //     }
  //   } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Update Owner Record"),
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ButtonTheme(
              ...
              child: RaisedButton(
                onPressed: () {
                  print(this.widget.ownerdata.id);
                  ...
                  ownerdata.update_by = update_by.text;

                //  _editOwner(context,this.widget.ownerdata.id, ownerdata);
