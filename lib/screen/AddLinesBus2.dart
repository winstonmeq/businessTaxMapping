...
class AddLineBus2 extends StatefulWidget {

  final int busId;
  final String busName;
  final Business busdata;
  AddLineBus2(this.busId, this.busName,this.busdata);

  // const lineBusiness({Key key}) : super(key: key);


  @override
  _AddLineBus2State createState() => _AddLineBus2State();
}

class _AddLineBus2State extends State<AddLineBus2> {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading:  IconButton(onPressed: (){
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => LineBus2(this.widget.busId, this.widget.busName,this.widget.busdata)),
            );
                        ...
                        child: ListTile(
                            ...
                            trailing: ElevatedButton(
                              onPressed: (){
                                ...
                                linebus.comment = "Added on ${arrayCat[index].category_name}, ${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}";
