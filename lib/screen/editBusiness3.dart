...
class EditBusiness3 extends StatefulWidget {
  final Business busdata;
  EditBusiness3(this.busdata);

  @override
  _EditBusiness3State createState() => _EditBusiness3State();
}

class _EditBusiness3State extends State<EditBusiness3> {
  ...
  changetext(){
    id.text = this.widget.busdata.id.toString();
  ...
  _businessSaveSQL(context,Business businessdata) async {
    try {
      ...
      if (addbusiness > 0) {
        ...
        print('business update to sqldatabase');
      } else {
